...
## [7.1.1](https://github.com/Fdawgs/node-unrtf/compare/v7.1.0...v7.1.1) (2026-03-21)
...
* **index:** race condition writing to same buffer concurrently ([#472](https://github.com/Fdawgs/node-unrtf/issues/472)) ([ce3ccda](https://github.com/Fdawgs/node-unrtf/commit/ce3ccda295e4d5538b7401a38cd6c2d982cb05dc))


### Continuous integration

* **cd:** use oicd for publishing to npm ([#471](https://github.com/Fdawgs/node-unrtf/issues/471)) ([f65809e](https://github.com/Fdawgs/node-unrtf/commit/f65809e755d5d8021ea960d88d37e15abc2b18eb))
* **deps:** bump actions/checkout from 4 to 5 ([#473](https://github.com/Fdawgs/node-unrtf/issues/473)) ([000f4cc](https://github.com/Fdawgs/node-unrtf/commit/000f4cc87a91ea52921eef7bec4d6afcd743ee8a))
* **deps:** bump actions/dependency-review-action from 4.7.1 to 4.7.3 ([#474](https://github.com/Fdawgs/node-unrtf/issues/474)) ([bb4e825](https://github.com/Fdawgs/node-unrtf/commit/bb4e8253de5b54ff7b491c305ec236736e26ef11))
* **deps:** bump googleapis/release-please-action from 4.2.0 to 4.3.0 ([#475](https://github.com/Fdawgs/node-unrtf/issues/475)) ([8a42a3b](https://github.com/Fdawgs/node-unrtf/commit/8a42a3b367ee04402780567c1f27cf6a9f9a2e3d))
...
* **cd:** grant issue write permissions for tags ([#441](https://github.com/Fdawgs/node-unrtf/issues/441)) ([542a2ac](https://github.com/Fdawgs/node-unrtf/commit/542a2ace07c9d0cb3ba0cc961b313ced2f6a55ab))
...
* **deps-dev:** bump @types/jest from 29.5.14 to 30.0.0 ([#445](https://github.com/Fdawgs/node-unrtf/issues/445)) ([87237b9](https://github.com/Fdawgs/node-unrtf/commit/87237b9e4499d332c9957db136390c287ea1dafe))
* **deps-dev:** bump jest from 29.7.0 to 30.0.3 ([#446](https://github.com/Fdawgs/node-unrtf/issues/446)) ([4a5a9d4](https://github.com/Fdawgs/node-unrtf/commit/4a5a9d4a28aded2e58f3b6e6bfa55463715b4cb7))
* **deps-dev:** migrate to eslint flat config ([#444](https://github.com/Fdawgs/node-unrtf/issues/444)) ([f4f8f7b](https://github.com/Fdawgs/node-unrtf/commit/f4f8f7b01821e5dd18c9f5c6735d941941480eea))
* **deps-dev:** replace license-checker with licensee ([#443](https://github.com/Fdawgs/node-unrtf/issues/443)) ([240529c](https://github.com/Fdawgs/node-unrtf/commit/240529cd971b379db97591bcbf7d2a9ae3e52189))


### Miscellaneous

* **license:** replace date range with `-present` ([#442](https://github.com/Fdawgs/node-unrtf/issues/442)) ([11be3ec](https://github.com/Fdawgs/node-unrtf/commit/11be3ecc46382fdd2335f05e0fba77bdcda0514c))
...
* **deps:** bump actions/dependency-review-action from 4.5.0 to 4.6.0 ([#426](https://github.com/Fdawgs/node-unrtf/issues/426)) ([fb5d14a](https://github.com/Fdawgs/node-unrtf/commit/fb5d14afe4296a3f797ffc9f42c6c8508466588c))
* **deps:** bump actions/setup-node from 4.3.0 to 4.4.0 ([#430](https://github.com/Fdawgs/node-unrtf/issues/430)) ([5451196](https://github.com/Fdawgs/node-unrtf/commit/5451196aaeb0390c030cda50ed6a1673c7ef5aad))
* **deps:** bump github/codeql-action from 3.28.12 to 3.28.13 ([#425](https://github.com/Fdawgs/node-unrtf/issues/425)) ([68740a9](https://github.com/Fdawgs/node-unrtf/commit/68740a9c79eb640c0fb180277a3685af2045b258))
* **deps:** bump github/codeql-action from 3.28.13 to 3.28.16 ([#429](https://github.com/Fdawgs/node-unrtf/issues/429)) ([7bd6c9c](https://github.com/Fdawgs/node-unrtf/commit/7bd6c9c956b0879241adb99f755f4199f2dffb20))
* use latest node lts version for unit tests ([#427](https://github.com/Fdawgs/node-unrtf/issues/427)) ([19be72c](https://github.com/Fdawgs/node-unrtf/commit/19be72c7c410e904909f3a0e8e3b749759caf6e9))


### Dependencies

* **deps-dev:** bump glob from 10.4.5 to 11.0.2 ([#431](https://github.com/Fdawgs/node-unrtf/issues/431)) ([aae3cae](https://github.com/Fdawgs/node-unrtf/commit/aae3cae1c03accdce08273a4b2d516a887760265))
...
* **index:** use `for` loop over `for...of` loop ([#432](https://github.com/Fdawgs/node-unrtf/issues/432)) ([3644c67](https://github.com/Fdawgs/node-unrtf/commit/3644c67505e8c627baaf49f76187bc19c9db9f54))
